# agent-infra-edge-link-resolver-secure-vtx

## Detailed Description

agent-infra-edge-link-resolver-secure-vtx is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
